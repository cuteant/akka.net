...
namespace Akka.Actor
{
    ...
    public abstract class ActorRefBase : IActorRef
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            var actorRef = obj as IActorRef;
            if (null == actorRef) { AkkaThrowHelper.ThrowArgumentException(AkkaExceptionResource.Argument_ActorRefCompareTo, AkkaExceptionArgument.obj); }
...
*/
    ...
    internal sealed class FunctionRef : MinimalActorRef
    {
        ...
        private readonly IHandle<IActorRef, object> _tell;
        ...
        public FunctionRef(ActorPath path, IActorRefProvider provider, EventStream eventStream, IHandle<IActorRef, object> tell)
        {
        ...
        protected override void TellInternal(object message, IActorRef sender) => _tell.Handle(sender, message);
