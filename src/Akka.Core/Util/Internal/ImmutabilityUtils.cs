...
namespace Akka.Util.Internal
{
    ...
    internal static class ImmutabilityUtils
    {
        ...
        {
            if (set is null) AkkaThrowHelper.ThrowArgumentNullException(AkkaExceptionArgument.set, AkkaExceptionResource.ArgumentNull_CopyAndAdd);
        ...
        {
            if (set is null) AkkaThrowHelper.ThrowArgumentNullException(AkkaExceptionArgument.set, AkkaExceptionResource.ArgumentNull_CopyAndRemove);
            // ReSharper disable once PossibleNullReferenceException
