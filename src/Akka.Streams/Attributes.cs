...
namespace Akka.Streams
{
    ...
    public sealed class Attributes
    {
        ...
        {
            var result = _attributes.First(attr => attr is TAttr) as TAttr;
            if (result is null)
            {
                ThrowHelper.ThrowIllegalStateException_Mandatory_attribute_not_found<TAttr>();
            }
            return result;
        }
    ...
    public static class ActorAttributes
    {
            ...
            IEquatable<StreamSubscriptionTimeout>
        {
            ...
            {
                if (timeout.Ticks < 0) { ThrowHelper.ThrowArgumentException_Timeout_must_be_finite(); }
                Timeout = timeout;
                Mode = mode;
            }
    ...
    public static class StreamRefAttributes
    {
        ...
        public sealed class BufferCapacity : IStreamRefAttribute, IEquatable<BufferCapacity>
        {
            ...
            {
                if (capacity <= 0) { ThrowHelper.ThrowArgumentException_Capacity_must_be_greater_than_zero(); }
                Capacity = capacity;
            }
