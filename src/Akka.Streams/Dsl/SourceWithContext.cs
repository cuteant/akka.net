...
namespace Akka.Streams.Dsl
{
    ...
    /// API MAY CHANGE
    /// </summary>
    public sealed class SourceWithContext<TCtx, TOut, TMat> : GraphDelegate<SourceShape<Tuple<TOut, TCtx>>, TMat>
    {
        public SourceWithContext(Source<Tuple<TOut, TCtx>, TMat> source)
        : base(source)
        {
        }
        ...
        public SourceWithContext<TCtx2, TOut2, TMat> Via<TCtx2, TOut2, TMat2>(
            IGraph<FlowShape<Tuple<TOut, TCtx>, Tuple<TOut2, TCtx2>>, TMat2> viaFlow) =>
        ...
        public SourceWithContext<TCtx2, TOut2, TMat3> ViaMaterialized<TCtx2, TOut2, TMat2, TMat3>(
            IGraph<FlowShape<Tuple<TOut, TCtx>, Tuple<TOut2, TCtx2>>, TMat2> viaFlow, Func<TMat, TMat2, TMat3> combine) =>
