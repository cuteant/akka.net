...
namespace Akka.Cluster.Tools.PublishSubscribe
{
    ...
    public class DistributedPubSubMediator : ReceiveActorSlim
    {
        ...
        public DistributedPubSubMediator(DistributedPubSubSettings settings)
        {
            ...
            Receive<SendToAll>(e => HandleSendToAll(e));
            Receive<Publish>(e => HandlePublish(e));
            Receive<Put>(e => HandlePut(e));
            Receive<Remove>(e => HandleRemove(e));
            Receive<Subscribe>(e => HandleSubscribe(e));
            Receive<RegisterTopic>(e => HandleRegisterTopic(e));
            Receive<NoMoreSubscribers>(e => HandleNoMoreSubscribers(e));
            Receive<NewSubscriberArrived>(e => HandleNewSubscriberArrived(e));
            Receive<GetTopics>(e => HandleGetTopics(e));
            Receive<Subscribed>(e => HandleSubscribed(e));
            Receive<Unsubscribe>(e => HandleUnsubscribe(e));
            Receive<Unsubscribed>(e => HandleUnsubscribed(e));
            Receive<Status>(e => HandleStatus(e));
            Receive<Delta>(e => HandleDelta(e));
            Receive<GossipTick>(e => HandleGossip(e));
            ...
            Receive<ClusterEvent.MemberWeaklyUp>(e => HandleMemberWeaklyUp(e));
            Receive<ClusterEvent.MemberLeft>(e => HandleMemberLeft(e));
            Receive<ClusterEvent.MemberDowned>(e => HandleMemberDowned(e));
            ...
            Receive<Count>(e => HandleCount(e));
            Receive<DeltaCount>(e => HandleDeltaCount(e));
            Receive<CountSubscribers>(e => HandleCountSubscribers(e));
        }
