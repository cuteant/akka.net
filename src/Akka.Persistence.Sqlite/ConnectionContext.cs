...
namespace Akka.Persistence.Sqlite
{
    ...
    {
        private static readonly ConcurrentDictionary<string, SqliteConnection> Remembered = new ConcurrentDictionary<string, SqliteConnection>(StringComparer.Ordinal);
