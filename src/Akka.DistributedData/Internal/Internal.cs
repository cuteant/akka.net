...
namespace Akka.DistributedData.Internal
{
    ...
    public sealed class DeltaPropagation : IReplicatorMessage, IEquatable<DeltaPropagation>
    {
        ...
        /// in <see cref="T:DeltaPropagationSelector.CreateDeltaPropagation(ImmutableDictionary{string, (IReplicatedData data, long from, long to)})"/>, i.e. never sent to the other replicas.
        /// </summary>
