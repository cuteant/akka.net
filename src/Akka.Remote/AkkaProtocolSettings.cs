...
namespace Akka.Remote
{
    ...
    public class AkkaProtocolSettings
    {
        ...
        {
            if (config.IsNullOrEmpty()) { throw ConfigurationException.NullOrEmptyConfig<AkkaProtocolSettings>(); }
            ...
            var enabledTransports = config.GetStringList("akka.remote.enabled-transports", EmptyArray<string>.Instance);
