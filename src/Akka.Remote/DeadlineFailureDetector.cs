...
{
    /// <summary>This class represents a <see cref="FailureDetector"/> that uses an absolute timeout of
    /// missing heartbeats to trigger unavailability.</summary>
    public class DeadlineFailureDetector : FailureDetector
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="DeadlineFailureDetector"/> class.</summary>
        ...
        /// name="acceptableHeartbeatPause"/> is less than zero.</li><li>The specified <paramref
        /// name="heartbeatInterval"/> is less than zero</li></ul>
        /// </exception>
        ...
        /// <summary>Initializes a new instance of the <see cref="DeadlineFailureDetector"/> class.</summary>
        /// <param name="config">The configuration used to configure this failure detector. <note>The configuration must
        /// define the 'akka.cluster.failure-detector.acceptable-heartbeat-pause' key.</note>.</param>
        ...
        /// <summary>Determines whether the resource is considered to be up and healthy.</summary>
