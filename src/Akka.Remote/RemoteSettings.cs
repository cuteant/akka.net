...
{
    /// <summary>This class represents configuration information used when setting up remoting.</summary>
    public class RemoteSettings
    {
        /// <summary>Initializes a new instance of the <see cref="RemoteSettings"/> class.</summary>
        ...
        public RemoteSettings(Config config)
        {
            ...
            if (string.Equals(config.GetString(bufferSizeLogKey), "off", StringComparison.OrdinalIgnoreCase) ||
                ...
                string.Equals(config.GetString(bufferSizeLogKey), "no", StringComparison.OrdinalIgnoreCase))
            {
            ...
            TrustedSelectionPaths = new HashSet<string>(config.GetStringList("akka.remote.trusted-selection-paths", EmptyArray<string>.Instance), StringComparer.Ordinal);
        ...
        /// <summary>Used for augmenting outbound messages with the Akka scheme</summary>
        ...
        public class TransportSettings
        {
            ...
            public TransportSettings(Config config)
            {
                ...
                Adapters = config.GetStringList("applied-adapters", EmptyArray<string>.Instance).Reverse().ToList();
                Config = config;
            }
