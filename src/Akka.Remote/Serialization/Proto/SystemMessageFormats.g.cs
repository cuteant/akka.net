...
namespace Akka.Remote.Serialization.Proto.Msg {
  ...
  public static partial class SystemMessageFormatsReflection {
  ...
  #region Messages
  public sealed partial class CreateData : pb::IMessage<CreateData> {
  ...
  public sealed partial class RecreateData : pb::IMessage<RecreateData> {
  ...
  public sealed partial class ResumeData : pb::IMessage<ResumeData> {
  ...
  public sealed partial class SuperviseData : pb::IMessage<SuperviseData> {
  ...
  public sealed partial class FailedData : pb::IMessage<FailedData> {
  ...
  public sealed partial class DeathWatchNotificationData : pb::IMessage<DeathWatchNotificationData> {
