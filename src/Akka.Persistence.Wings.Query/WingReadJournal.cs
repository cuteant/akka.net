...
{
    public class WingReadJournal : IReadJournal,
        IEventsByPersistenceIdQuery,
        ICurrentEventsByPersistenceIdQuery,
        IEventsByTagQuery,
        ICurrentEventsByTagQuery
    {
        public static string Identifier = "akka.persistence.query.journal.wings";
        ...
        {
            return ConfigurationFactory.FromResource<WingReadJournal>("Akka.Persistence.Wings.Query.reference.conf");
        }
        ...
        public WingReadJournal(ExtendedActorSystem system, Config config)
        {
