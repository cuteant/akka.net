...
namespace Akka.Persistence.Tests
{
    class ReceiveTimeoutAsyncActor2 : ReceivePersistentActor2
    {
        ...
        public ReceiveTimeoutAsyncActor2(string persistenceId)
        {
    ...
    class AsyncActor2 : ReceivePersistentActor2
    {
        ...
        public AsyncActor2(string persistenceId)
        {
            PersistenceId = persistenceId;
    ...
    public class SuspendActor2 : ReceivePersistentActor2
    {
        ...
        public SuspendActor2(string persistenceId)
        {
            PersistenceId = persistenceId;
    ...
    public class AsyncAwaitActor2 : ReceivePersistentActor2
    {
        ...
        public AsyncAwaitActor2(string persistenceId)
        {
            PersistenceId = persistenceId;
    ...
    public class PersistentAsyncAwaitActor2 : PersistentActor
    {
        public override string PersistenceId { get; }

        public PersistentAsyncAwaitActor2(string persistenceId)
        {
            PersistenceId = persistenceId;
        }
    ...
    public class Asker2 : ReceivePersistentActor2
    {
        ...
        public Asker2(string persistenceId, IActorRef other)
        {
            PersistenceId = persistenceId;
    ...
    public class PersistentAsker2: PersistentActor
    {
        private readonly IActorRef _other;

        public override string PersistenceId { get; }

        public PersistentAsker2(string persistenceId, IActorRef other)
        {
            PersistenceId = persistenceId;
            _other = other;
        }
    ...
    public class BlockingAsker2 : ReceivePersistentActor2
    {
        ...
        public BlockingAsker2(string persistenceId, IActorRef other)
        {
            PersistenceId = persistenceId;
    ...
    public class BlockingAskSelf2 : ReceivePersistentActor2
    {
        ...
        public BlockingAskSelf2(string persistenceId)
        {
            PersistenceId = persistenceId;
    ...
    public class AsyncExceptionActor2 : ReceivePersistentActor2
    {
        ...
        public AsyncExceptionActor2(string persistenceId, IActorRef callback)
        {
            PersistenceId = persistenceId;
    ...
    public class AsyncTplActor2 : ReceivePersistentActor2
    {
        ...
        public AsyncTplActor2(string persistenceId)
        {
            PersistenceId = persistenceId;
    ...
    public class AsyncTplExceptionActor2 : ReceivePersistentActor2
    {
        ...
        public AsyncTplExceptionActor2(string persistenceId, IActorRef callback)
        {
            PersistenceId = persistenceId;
    ...
    public class ReceivePersistentActor2AsyncAwaitSpec : AkkaSpec
    {
        ...
        {
            var actor = Sys.ActorOf(Props.Create(() => new PersistentAsyncAwaitActor2("pid")), "Worker");
            var asker = Sys.ActorOf(Props.Create(() => new PersistentAsker2("pid", actor)), "Asker");
        ...
        {
            var actor = Sys.ActorOf(Props.Create(() => new AsyncAwaitActor2("pid")));
        ...
        {
            var actor = Sys.ActorOf(Props.Create(() => new AsyncAwaitActor2("pid")), "Worker");
            var asker = Sys.ActorOf(Props.Create(() => new Asker2("pid", actor)), "Asker");
            var task = asker.Ask("start");
            actor.Tell(123, ActorRefs.NoSender);
            var res = await task;
            Assert.Equal("done", res);
        ...
        {
            var actor = Sys.ActorOf(Props.Create(() => new AsyncAwaitActor2("pid")).WithDispatcher("akka.actor.task-dispatcher"), "Worker");
            var asker = Sys.ActorOf(Props.Create(() => new BlockingAsker2("pid", actor)).WithDispatcher("akka.actor.task-dispatcher"), "Asker");
            var task = asker.Ask("start");
            actor.Tell(123, ActorRefs.NoSender);
            var res = await task;
            Assert.Equal("done", res);
        ...
        {
            var asker = Sys.ActorOf(Props.Create(() => new BlockingAskSelf2("pid")), "Asker");
            var task = asker.Ask("start");
            var res = await task;
            Assert.Equal("done", res);
        }
        ...
        {
            var asker = Sys.ActorOf(Props.Create(() => new AsyncExceptionActor2("pid", TestActor)));
            asker.Tell("start");
        ...
        {
            var asker = Sys.ActorOf(Props.Create(() => new AsyncTplActor2("pid")));
        ...
        {
            var asker = Sys.ActorOf(Props.Create(() => new AsyncTplExceptionActor2("pid", TestActor)));
            asker.Tell("start");
            ExpectMsg("done", TimeSpan.FromSeconds(5));
        }
        ...
        {
            var asker = Sys.ActorOf(Props.Create(() => new SuspendActor2("pid")));
        ...
        {
            var asker = Sys.ActorOf(Props.Create(() => new AsyncActor2("pid")));
        ...
        public void Actor_should_be_able_to_ReceiveTimeout_after_async_operation()
        {
            ...
            var actor = Sys.ActorOf(Props.Create(() => new ReceiveTimeoutAsyncActor2(pid)));
        ...
        public class AsyncExceptionCatcherActor2 : ReceivePersistentActor2
        {
            ...
            public AsyncExceptionCatcherActor2(string persistenceId)
            {
                PersistenceId = persistenceId;
        ...
        {
            var actor = Sys.ActorOf(Props.Create(() => new AsyncExceptionCatcherActor2("pid")));
        ...
        public class AsyncFailingActor2 : ReceivePersistentActor2
        {
            ...
            public AsyncFailingActor2(string persistenceId)
            {
                PersistenceId = persistenceId;
        ...
        {
            var actor = Sys.ActorOf(Props.Create(() => new AsyncFailingActor2("pid")));
        ...
        public class AsyncPipeToDelayActor2 : ReceivePersistentActor2
        {
            ...
            public AsyncPipeToDelayActor2(string persistenceId)
            {
                PersistenceId = persistenceId;
        ...
        public class AsyncReentrantActor2 : ReceivePersistentActor2
        {
            ...
            public AsyncReentrantActor2(string persistenceId)
            {
                PersistenceId = persistenceId;
        ...
        {
            var actor = Sys.ActorOf(Props.Create(() => new AsyncReentrantActor2("pid")));
            actor.Tell("hello");
        ...
        {
            var actor = Sys.ActorOf(Props.Create(() => new AsyncPipeToDelayActor2("pid")));
